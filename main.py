...
# # Load the vectorizer and SVM model from disk (created with joblib.dump)
...
#     X_vec = vectorizer.transform([text])  # TF-IDF transform
...
#     else:
#         confidence = 0.0  # Default if predict_proba is not available
#     # Return as JSON
